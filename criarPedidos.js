...
function setOptions (method,url,json,cookie){
    return  {
        ...
        headers: {
            ...
            'X-PROVIDER-API-AppKey': 'vtexappkey-dreamscape-FMYVGX',
                'X-VTEX-API-AppKey': 'vtexappkey-dreamscape-FMYVGX',
            'X-PROVIDER-API-AppToken': 'BJAZBUUCECOLTNJLGRQDTJIILLWRQSTKJYUKLVIJBOSHOJSEXVLMJTDPXAUMNSRDTXEOUFZTBZRDVOXFTTJGYVXUWUPIOXENMWGDXXVQHASKUJWGDFAXNHLRBFEJPURG',
